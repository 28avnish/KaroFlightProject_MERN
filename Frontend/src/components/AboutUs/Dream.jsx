        ...
        <div className="flex flex-col items-center justify-between space-y-5 w-full">
          ...
          <div className="flex w-full h-[250px] relative my-7 justify-center lg:justify-start">
            ...
            <div className="relative mt-15 hidden lg:block">
              <img src={dottedLine} className=" rotate-130 sm:block hidden scale-105 " />
              <div className="rotate-90 absolute top-30 right-64">
                <FaPlane className="h-15 w-10" />
              </div>
            </div>

            <div className="flex items-start justify-end bg-white p-5 rounded-2xl w-[350px] h-[230px]">
              <div className="flex flex-col gap-1">
                <h2 className="text-[20px] font-semibold text-left">
                  A Global Travel Partner
                </h2>
                <p className={`${textLightGray} text-[18px] text-left `}>
                  Travel means freedom to explore the beautiful world.
                  People should feel planning and booking is simple and
                  not stressful. We know that you wish to have the
                  best deals with flexible choices.
                </p>
                <div className="flex w-full justify-end items-center text-[10px] font-bold "><p className="flex items-center gap-2 hover:scale-125 hover:underline cursor-pointer transition-transform duration-300">Read more <span><FaArrowRight/></span></p></div>
              </div>
            </div>
            </div>
          </div>
          ...
          <div className="flex items-start justify-start  lg:-ml-100">
            ...
            <div className=" flex items-center justify-center md:items-start  bg-white p-5 rounded-2xl z-50">
          ...
          <div className="flex items-center justify-center gap-2.5 w-full mb-20">
            ...
            <div className="flex items-center  justify-center mx-30 ">
              <div className="hidden lg:flex w-full h-[110px] relative ">
                ...
                <p className={`${textLightGray} text-[18px] text-left`}>
                  We guarantee no hidden fees, surprise cost, or
                  biasness. You always get what you see here.
                </p>
                </div>
              </div>

              {/* 3rd box Mobile View */}
              <div className="flex lg:hidden w-full h-[110px] relative ">
          ...
          <div className="flex items-center justify-between flex-row-reverse gap-2.5 my-10 ">
            <div className="relative mt-15 hidden lg:block">
              <div className="relative h-15 w-80">
              <img src={dottedLine} className="rotate-170 sm:block hidden absolute -top-40 left-30" style={{ transform: "scaleX(-1)" }} />
              </div>
            ...
            <div className="flex items-center justify-center bg-white p-2 rounded-2xl  w-[320px] h-[200px]">
