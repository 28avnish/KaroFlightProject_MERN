...
const HeroSection = ({}) => {
  ...
  return (
    <section className="relative w-full h-[110vh] md:h-screen overflow-hidden">
      ...
      <div className="relative w-full  h-[110vh] md:h-[120vh] overflow-hidden">
        <video
      ...
      <div
        className="absolute inset-0 flex flex-col items-center justify-center text-center px-3 sm:px-4 space-y-4"
      ...
      >
        ...
        <div className=" w-full max-w-4xl mx-auto">
          <h1 className="mb-3 text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-[56px] xl:text-[60px] font-bold text-white leading-tight  px-2">
            Find Your Perfect <span className="text-[#FF621F]">Hotel Now</span>
          </h1>
          <p className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-white px-2 sm:px-4 md:px-0 max-w-3xl mx-auto leading-relaxed">
            Your next trip may be closer than you just wonder. Find out the best
            hotels today with just one click.
          </p>
        </div>
            ...
            <form className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4 items-center">
              ...
              <div className="col-span-1 sm:col-span-2 lg:col-span-4 mt-2 sm:mt-3">
                <button
                  ...
                  className="w-full cursor-pointer bg-orange-500 text-white font-medium py-2 sm:py-3 rounded-lg hover:bg-orange-600 transition text-xs sm:text-sm md:text-base"
                >
                  Search hotels
                </button>
              </div>
