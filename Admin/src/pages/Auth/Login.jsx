      ...
      <div className="flex flex-wrap h-screen justify-center items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            <p className="text-2xl">Welcome to the Karo Flight Admin Panel</p>
        ...
        <div className="w-full border-stroke  xl:w-1/2 xl:border-l-2 mb-14">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="">
                <button
                  disabled={isLoading}
                  className="mt-5 inline-flex w-full items-center justify-center rounded-md bg-[#222A59] hover:bg-blue-950 cursor-pointer px-3.5 py-2.5 font-semibold leading-7 text-white"
                >
