...
const CreateTour = () => {
  ...
  const {
    fields: tripHighlightsFields,
    append: appendTripHighlights,
    remove: removeTripHighlights,
  } = useFieldArray({
    control,
    name: "tripHighlights",
  });
  ...
  const {
    ...
    append: appendAvailableDates,
    remove: removeAvailableDates,
  } = useFieldArray({
    control,
    name: "availableDates",
  });
          ...
          >
            ...
            <div className="sm:flex space-y-6 sm:space-y-0 justify-between gap-10">
              <div className="w-full">
                ...
                />
                {errors.activity && (
                  <span className="text-red-500">Activity is required</span>
                )}
              </div>
              ...
              <div className="w-full">
                ...
                />
                {errors.season && (
                  <span className="text-red-500">Season is required</span>
                )}
              </div>
            </div>
            <div className="sm:flex space-y-6 sm:space-y-0 justify-between gap-10">
            ...
            <div className="sm:flex space-y-6 sm:space-y-0 justify-between gap-10">
              ...
              <div className="w-full">
                ...
                <input
                  {...register("highestPoint", {
                    required: "Highest Point is required",
                  })}
                  type="text"
                  className="w-full mt-2 me-35 px-5 py-2 text-gray-500 border-slate-300 bg-transparent outline-none border focus:border-teal-400 shadow-sm rounded-lg"
                />
            ...
            <div className="flex justify-between">
              <div className="text-2xl text-black">
                ...
                <span className="text-base">
                  (Start Date - End Date - Group Size)
                </span>
              </div>
              <button
                type="button"
              ...
              {availableDatesFields.map((item, index) => (
                <li key={item.id}>
                  <div className="sm:flex justify-between gap-10">
                    <input
                      {...register(`availableDates.${index}.startDate`, {
                    ...
                    />
                    <input
                      {...register(`availableDates.${index}.endDate`, {
                    ...
                    />
                    <input
                      {...register(`availableDates.${index}.totalSeats`, {
                  ...
                  {index > 0 && (
                    <button
                      ...
                      type="button"
                      onClick={() => removeAvailableDates(index)}
                    >
                      Delete
                    </button>
                  )}
              ...
              {tripHighlightsFields.map((item, index) => (
                <li key={item.id}>
                  <div className="sm:flex gap-10 ">
                    <div className="w-full">
                      <input
                        {...register(`tripHighlights.${index}`, {
                          required: "Trip Hilghlights are required",
                        })}
                        type="text"
                  ...
                  {index > 0 && (
                    <button
                      className=" border rounded-md bg-rose-500 text-white text-xs px-2 hover:bg-slate-950"
                      type="button"
                      onClick={() => removeTripHighlights(index)}
                    >
                      Delete
                    </button>
                  )}
            ...
            <div className="full space-y-3">
              ...
              {errors?.itinerary && (
                <span className=" text-red-500">Itinerary is required</span>
              )}
            </div>
            ...
            <div className="w-full">
              <div className=" space-y-6">
                {" "}
                <span className="text-2xl text-black">Map</span>
                <img
                  class="mt-2 w-20 h:20 sm:w-44 sm:h-36 rounded"
                  src={mapPhoto || defaultPhoto}
                  alt="No Image"
                />
                <label
                  htmlFor="file_input1"
