...
import { deleteAdminUser, getAdminUsers } from "../../../features/action/auth";
import { MdCircle } from "react-icons/md";

const ViewAdminUsers = () => {
  const { adminsData, isDeleted, isLoading } = useSelector(
    (state) => state.auth
  );
        ...
        <div className="items-start justify-between md:flex">
          <div className="max-w-lg">
            ...
            <p className="text-gray-600 mt-2">
              This page is for handle admins by Create, Update and Delete.
            </p>
          </div>
          ...
          <table className="w-full table-auto text-sm text-left ">
            <thead className="bg-gray-50 text-gray-600 font-medium border-b justify-between">
              <tr>
                ...
                <th className="py-3 px-6">Panel Access</th>
                  ...
                  <tr key={idx}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      item?.modules.length > 0 ? (
                        item?.modules?.map((module, idy) => (
                          <div
                            className=" bg-slate-100 flex mb-2 rounded-md px-2 gap-2 w-fit"
                            key={idy}
                          >
